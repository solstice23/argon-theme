...
function argon_entry_donate(){
    get_template_part( 'template-parts/entry_donate', get_post_type() );
}

// 标签模块
add_action( 'argon_entry_tag', 'argon_entry_tag' );
function argon_entry_tag(){
    get_template_part( 'template-parts/entry_tag', get_post_type() );
}
...
function argon_entry_footer(){
    // get_template_part( 'template-parts/entry_footer', get_post_type() );
...
function argon_post_navigation() {
	get_template_part( 'template-parts/entry-post-navigation', get_post_type() );
}

// related posts.
add_action( 'argon_related_post', 'argon_related_post' );
function argon_related_post() {
	get_template_part( 'template-parts/entry-related', get_post_type() );
}
