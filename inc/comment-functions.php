<?php
//解析 UA 和相应图标
require_once(get_template_directory() . '/inc/useragent-parser.php');
...
add_rewrite_rule('^unsubscribe-comment-mailnotice/?(.*)$', '/wp-content/themes/argon/inc/unsubscribe-comment-mailnotice.php$1', 'top');
//编辑评论
